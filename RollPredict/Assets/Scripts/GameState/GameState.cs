...
/// 包含所有游戏状态数据，支持克隆和序列化
/// 
/// 使用 OrderedDictionary 确保遍历顺序的一致性，避免帧同步不同步问题
/// </summary>
[Serializable]
public class GameState
{
    /// <summary>
    /// 玩家状态有序字典 (playerId -> PlayerState)
    /// 使用 OrderedDictionary 确保遍历顺序一致，避免帧同步不同步
    /// </summary>
    public OrderedDictionary<int, PlayerState> players;

    /// <summary>
    /// 物理体状态有序字典 (bodyId -> PhysicsBodyState)
    ...
    /// </summary>
    public OrderedDictionary<int, PhysicsBodyState> physicsBodies;
    ...
    public GameState()
    {
        players = new OrderedDictionary<int, PlayerState>();
        physicsBodies = new OrderedDictionary<int, PhysicsBodyState>();
        frameNumber = 0;
    }
    ...
    public GameState Clone()
    {
        ...
        // OrderedDictionary 的遍历顺序是确定的（按插入顺序）
