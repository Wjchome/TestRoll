...
namespace FixMath.NET {
    ...
    struct Fix8 : IEquatable<Fix8>, IComparable<Fix8> {
        ...
        public static Fix8 Abs(Fix8 value) {
            ...
            // 对于正数，最高位为 0 ，移位后为 0000 0000  ->  0 
            // 对于负数，最高位为 1 ，移位后为 1111 1111  -> -1
            var mask = (sbyte)(value.m_rawValue >> 7);
            //  十进制      原码           反码            补码           Fix8(将补码 << 4)                     操作                         结果
            // -3      1 000 0011     1 111 1100      1 111 1101          1 101 0000           1 100 1111  (-49) ^ 1 111 1111   0 011 0000 ->  3
            //  5      0 000 0101     0 000 0101      0 000 0101          0 101 0000           0 101 0000   (80) ^ 0 000 0000   0 101 0000 ->  5
            //  2.5    0 000 0010 1   0 000 0010 1    0 000 0010 1        0 010 1000           0 010 1000   (40) ^ 0 000 0000   0 010 1000 ->  2.5
            // -1.5    1 000 0001 1   1 111 1110 0    1 111 1110 1        1 110 1000           1 110 0111  (-25) ^ 1 111 1111   0 001 1000 ->  1.5
            return new Fix8((sbyte)((value.m_rawValue + mask) ^ mask));//操作
        }
        ...
        public static Fix8 Floor(Fix8 value) {
            ...
            // 正数没问题
            //  十进制            补码               Fix8(将补码 << 4)            结果( & 0xF0)     
            // -1.5          1 111 1110 1            1 110 1000 (-24)           1 110 0000  (-32)                          
        ...
        public static Fix8 Round(Fix8 value) {
            ...
            // if number is halfway between two values, round to the nearest even number 1 000 0010 10  1 111 1101 01
            // this is the method used by System.Math.Round().
            //
            // 二进制          补码             Fix8            操作1                  操作2                     返回
            // 3.25      0 000 0011 01     0 011 0100     < 0000 1000                                     0 011 0000(3)
            // 3.5       0 000 0011 10     0 011 1000           =       0 011 0000 & 0 001 0000 !=0           (4) 
            // 2.5       0 000 0010 10     0 010 1000           =       0 010 0000 & 0 001 0000 ==0           (2) 
            // -2.5      1 111 1101 10     1 101 1000           =       1 101 1000 & 0 001 0000 !=0           (-2)
        ...
        public static Fix8 Sqrt(Fix8 x) {
            ...
            // second-to-top bit 0 0100 000 4 >2.25
            byte bit = 1 << 6;
            ...
            for (var n = 0; n < 2; n++) {
                ...
                while (bit != 0) {
                    if (num >= result + bit) {   //2.5>=0+1
                        num -= (byte)(result + bit); //num = 1.5
                        result = (byte)((result >> 1) + bit); //result = 1
                    }
                    else {
